...
const functionsData = [
  { id: "1", name: "Mood Check-In", color: "#FF9500", route: "/functions/mood-check", icon: "happy" },
  ...
  { id: "5", name: "Emergency & Support", color: "#FF3B30", route: "/functions/EmergencyContact", icon: "call" },
];
